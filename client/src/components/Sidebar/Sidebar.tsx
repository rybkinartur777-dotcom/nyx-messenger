        ...
        <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
            <div className="sidebar-header">
                ...
                <div style={{ display: 'flex', gap: '10px', marginLeft: 'auto', alignItems: 'center' }}>
                    <button className="btn btn-ghost" onClick={handleCreateNotes} title="Избранное (Заметки)" style={{ width: '32px', height: '32px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 0, borderRadius: '50%', background: 'rgba(255,255,255,0.03)' }}>
                    ...
                    <button className="new-chat-btn-top add-contact-btn" onClick={handleAddContactClick} title="Создать новый чат" style={{ width: '32px', height: '32px', flexShrink: 0, padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        +
                    </button>
                </div>
            </div>

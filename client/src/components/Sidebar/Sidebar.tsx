        ...
        <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
            <div className="sidebar-header">
                ...
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    <button className="btn btn-ghost" onClick={handleCreateNotes} title="Избранное (Заметки)" style={{ padding: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
